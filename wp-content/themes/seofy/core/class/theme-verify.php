    ...
    class Wgl_Theme_Verify{
        ...
        */
        ...
        private function hooks(){
            ...
            add_action( 'wp_before_admin_bar_render', array($this,'admin_bar_links'), 80);
        }
        ...
        public function admin_bar_links(  ) {
            ...
            if(is_admin() && current_user_can('manage_options')){
                $wp_admin_bar->add_menu( array(
                    'parent'    => false,
                    'id'        => 'wgl_activate-theme',
                    'title'     => esc_html__('Activate Theme', 'seofy'),
                    'href'      => esc_url( admin_url( 'admin.php?page=wgl-activate-theme-panel' ) ),
                    'meta'      => array( 'class' => 'wgl_activate_theme-admin_bar' )
                ) );            
            }else{
                return;
            }
