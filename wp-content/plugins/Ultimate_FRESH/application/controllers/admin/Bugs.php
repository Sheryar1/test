...
class Bugs extends Admin_Controller
{
    ...
    public function bugsList($filterBy = null, $search_by = null)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->datatables->column_order = array('issue_no', 'bug_title', 'tbl_account_details.fullname', 'created_time', 'severity', 'priority', 'bug_status');
            $this->datatables->column_search = array('issue_no', 'bug_title', 'tbl_account_details.fullname', 'created_time', 'severity', 'priority', 'bug_status');
