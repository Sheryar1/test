...
class Tasks extends Admin_Controller
{
    ...
    public function tasksList($filterBy = null, $search_by = null)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->datatables->column_order = array('task_name', 'task_status', 'task_start_date', 'due_date');
            $this->datatables->column_search = array('task_name', 'task_status', 'task_start_date', 'due_date');
