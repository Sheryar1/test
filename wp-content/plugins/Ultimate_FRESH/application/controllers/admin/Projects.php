...
//        $data['all_project_info'] = $this->items_model->get_all_project($this->uri->segment(4));
    ...
    public function projectList($filterBy = null, $search_by = null)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->datatables->column_order = array('tbl_project.project_name', 'tbl_client.name', 'tbl_project.start_date', 'tbl_project.end_date');
            $this->datatables->column_search = array('tbl_project.project_name', 'tbl_client.name', 'tbl_project.end_date', 'tbl_project.project_status');
