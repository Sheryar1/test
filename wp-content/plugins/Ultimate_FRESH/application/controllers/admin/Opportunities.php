...
class Opportunities extends Admin_Controller
{
    ...
    public function opportunitiesList($type = null)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->datatables->column_order = array('opportunity_name', 'stages', 'expected_revenue', 'next_action', 'next_action_date');
            $this->datatables->column_search = array('opportunity_name', 'stages', 'expected_revenue', 'next_action', 'next_action_date');
