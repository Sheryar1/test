...
class Goal_Tracking extends Admin_Controller
{
    ...
    public function goal_trackingList($type = null)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->datatables->column_order = array('subject', 'tbl_goal_type.type_name', 'achievement', 'start_date', 'end_date', 'account_id', 'tbl_goal_tracking.description');
            $this->datatables->column_search = array('subject', 'tbl_goal_type.type_name', 'achievement', 'start_date', 'end_date', 'account_id', 'tbl_goal_tracking.description');
